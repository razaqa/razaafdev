...
canvas = document.getElementById("canvas-cover");
...
colors = [
  ...
  '#fffeee', '#fffddd', '#fffccc', '#fffbbb', '#fffaaa',
  '#fff999', '#fff888', '#fff777', '#fff666', '#fff555'
];
...
resolution = parseFloat(1000);
speed = parseFloat(0.1);
radius = parseFloat(0.1);

var message = new shape(W / 2, H / 2 + 50, "RAZAAFDEV");
