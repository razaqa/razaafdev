...
@section('content')
    <div class="content">
        <div id="cover" class="uk-inline img-cover-height uk-height-large uk-background-cover uk-overflow-hidden uk-flex uk-flex-center" uk-parallax="opacity: 1, 0;" style="background-image: url('img/HomeCover.jpg');">
            <div class="uk-width-3-4@s uk-text-center uk-margin-auto uk-margin-auto-vertical">
                <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slideshow="animation: scale; autoplay: true; autoplay-interval: 4000;">
                    <ul class=" uk-slideshow-items uk-flex uk-flex-center">
                        <li>
                            <canvas id="canvas-cover"></canvas>
                        </li>
                        <li>
                            <h1 class="white uk-text-center uk-margin-auto uk-margin-auto-vertical headline">Hello. My name is Razaqa Dhafin Haffiyan</h1>
                        </li>
                        <li>
                            <h1 class="white uk-text-center uk-margin-auto uk-margin-auto-vertical headline">Welcome! Feel free to see all my works here..</h1>
                        </li>
                    </ul>
                </div>
            </div>
